...
<div class="card mt-3">
  ...
  <div class="card-body">
    <?php echo form_open('pemasukan/insert', ['class' => 'ajaxform', 'data-module' => 'pemasukan']) ?>
    <div class="form-row mb-2">
      <div class="form-group col-md-12">
        <?php echo form_label('Nomer', 'pemasukan-nomer') ?>
        <?php echo form_input(['name' => 'nomer', 'id' => 'pemasukan-nomer', 'class' => 'form-control', 'value' => $nomer, 'readonly' => 'true']) ?>
    ...
    <div class="form-row mb-2">
      <div class="form-group col-md-12">
        ...
        <?php echo form_dropdown('jenis', $jenis, null, ['class' => 'form-control selectpicker', 'id' => 'pemasukan-jenis', 'title' => sprintf('Pilih Jenis %s', $title)]) ?>
    ...
    <div class="form-row mb-2">
      <div class="form-group col-md-12">
        ...
        <div class="input-group">
          ...
          <?php echo form_input(['name' => 'jumlah', 'data-mask' => '000,000,000,000,000', 'data-mask-reverse' => 'true', 'id' => 'pemasukan-jumlah', 'class' => 'form-control rounded-right', 'placeholder' => sprintf('Jumlah %s', $title)]) ?>
    ...
    <div class="form-row mb-2">
      <div class="form-group col-md-12">
        ...
        <?php echo form_dropdown('cara_bayar', $cara_bayar, null, ['class' => 'form-control selectpicker', 'id' => 'pemasukan-cara_bayar', 'title' => sprintf('Pilih Cara Pembayaran %s', $title)]) ?>
    ...
    <div class="form-row mb-2">
      <div class="form-group col-md-12">
        ...
        <?php echo form_textarea(['name' => 'catatan', 'id' => 'pemasukan-catatan', 'class' => 'form-control', 'placeholder' => sprintf('Catatan %s', $title)]) ?>
