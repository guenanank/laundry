...
<div class="card mt-3">
  ...
  <div class="card-body">
    <?php echo form_open('pengeluaran/update/' . $pengeluaran->id, ['class' => 'ajaxform', 'data-module' => 'pengeluaran']) ?>
    ...
    <div class="form-row mb-2">
      <div class="form-group col-md-12">
        ...
        <div class="input-group">
          ...
          <?php echo form_input(['name' => 'jumlah', 'data-mask' => '000,000,000,000,000', 'data-mask-reverse' => 'true', 'id' => 'pengeluaran-jumlah', 'class' => 'form-control rounded-right', 'value' => $pengeluaran->jumlah]) ?>
    ...
    <div class="form-row mb-2">
      <div class="form-group col-md-12">
        ...
        <?php echo form_textarea(['name' => 'keterangan', 'id' => 'pengeluaran-keterangan', 'class' => 'form-control', 'value' => $pengeluaran->keterangan]) ?>
