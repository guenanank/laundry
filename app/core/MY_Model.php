...
class MY_Model extends CI_Model
{
    ...
    protected $_temporary_only_deleted = null;
    /**
    ...
    public function get_by()
    {
        ...
        if ($this->soft_delete) {
            ...
            $this->_database->where(sprintf('%s IS NULL', $this->soft_delete_key), null);
        }
    ...
    public function delete($id)
    {
        ...
        if ($this->soft_delete) {
            $result = $this->_database->update($this->_table, array( $this->soft_delete_key => date('Y-m-d H:i:s') ));
        } else {
    ...
    public function with_deleted()
    {
        ...
        $this->_database->where(sprintf('%s IS NOT NULL', $this->soft_delete_key), null);
        return $this;
    }
    /**
    ...
    {
        $this->_temporary_only_deleted = null;
        return $this;
    }
    /* --------------------------------------------------------------
     * OBSERVERS
